...
import { MdAddCard, MdGroupAdd } from "react-icons/md";
// import dashnavlogo from "../../assets/Navbar_logo/navlogo.png";
const CustomerMenu = () => {
  ...
  return (
    <div className="h-screen overflow-hidden container mx-auto pl-2 ">
      <Title></Title>
      <aside className="flex flex-col h-screen  px-2 lg:-mr-8 py-2 overflow-y-auto">
        ...
        <nav className="flex flex-col gap-1 flex-1 lg:mt-6 ">
          ...
          ><MdAddCard className="inline-block mr-2 text-xl"/>
            Add to Cart
          </NavLink>
          <NavLink
          ...
          > <FiShoppingCart className="inline-block mr-2 text-xl"/>
            My Orders
          </NavLink>
          {users1 && (
            <NavLink
          ...
          {!users1 && (
            ...
            > <MdGroupAdd className="inline-block mr-2 text-xl"/>
              Become Member
            </NavLink>
          )}
          <NavLink 
            to="/dashboard/customer/myprofile"
            className={({ isActive }) =>
              `relative inline-block px-0 py-2 mx-0 mt-2 transition-colors duration-700 transform rounded-md lg:mt-0 dark:text-gray-200 hover:text-[#E10101] font-semibold
                     ${
                 isActive
          ...
          <div className="flex flex-col justify-center items-start lg:mt-[330px]  mt-[150px]">
            <NavLink
              to="/"
              className={({ isActive }) =>
                `relative flex justify-center lg:ml-5 in-center px-0 py-2 mx-0 mt-2 transition-colors duration-700 transform rounded-md lg:mt-0 dark:text-gray-200 hover:text-[#E10101] font-semibold
                      ${
                        isActive
            ...
            <button
              ...
              className="cursor-pointer  px-2 -ml-1 mt-4 py-2 lg:w-[70%] text-sm font-medium tracking-wide text-white capitalize transition-colors duration-700 transform bg-red-600 rounded-lg hover:bg-red-500 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-80"
            >
