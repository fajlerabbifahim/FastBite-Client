...
const TopReviewedRestaurant = () => {
    ...
    return (
        <div className="py-10 w-11/12 mx-auto">
            <h1 className="text-4xl font-bold text-center mb-6"><span className="primary-color">Top Reviewed </span> Restaurants</h1>
            ...
            <div className="overflow-hidden whitespace-nowrap w-full relative py-6">
                <div className="flex gap-8 animate-marquee">
                    {repeatedRestaurants.map((restaurant, index) => (
                        ...
                        >
                            <img className="w-40 rounded-md" src={restaurant.image} alt={restaurant.name} />
                            <div className="flex flex-col justify-between">
                                <div>
                                    <h1 className="text-lg font-semibold">{restaurant.name}</h1>
                                    <p className="text-sm text-gray-600">{restaurant.location}</p>
                                </div>
                                <p className="text-yellow-500 font-medium">⭐ Rating: {restaurant.rating}</p>
                            </div>
                        </Link>
                    ))}
                </div>
