...
//       <div
//         className={` className='max-h-screen' lg:col-span-3 absolute inset-x-0 z-20 w-full transition-all duration-700 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent ${
//           isMenuOpen
