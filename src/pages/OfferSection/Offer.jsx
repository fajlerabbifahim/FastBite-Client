    ...
    <div className="flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
      <div className="relative bg-gradient-to-r from-red-100 to-orange-200 shadow-2xl rounded-lg p-8 md:p-12 w-full max-w-7xl overflow-hidden">
        ...
        <div className="text-center mt-8">
          <button className=" cursor-pointer px-8 py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-full text-lg font-semibold shadow-md hover:scale-105 transform transition-all">
            Become a Member
          </button>
        </div>
      </div>
